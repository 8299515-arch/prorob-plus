...
class DashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final modules = [
      ...
      _DashboardModule(Icons.task_alt, 'Задачи', 'Дедлайны, чек-листы и контроль', '/tasks'),
            ...
            itemBuilder: (context, index) {
              ...
              return Card(child: InkWell(
                ...
                child: Padding(padding: const EdgeInsets.all(18), child: Row(children: [
                  Icon(module.icon, size: 34), const SizedBox(width: 16),
                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(module.title, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4), Text(module.subtitle),
                    if (module.route == null) ...[const SizedBox(height: 5), Text('Скоро', style: Theme.of(context).textTheme.labelSmall)],
                  ])),
