...
abstract interface class FinanceRepository {
  ...
  Future<FinanceEntry> createEntry({required String projectId, required FinanceEntryType type, required String title, required double amount, String currency = 'UAH', String? category, DateTime? date});
...
class ApiFinanceRepository implements FinanceRepository {
  ...
  FinanceEntry _fromJson(Map<String, dynamic> json) => FinanceEntry(
        ...
        type: json['type'] == 'income' ? FinanceEntryType.income : FinanceEntryType.expense,
        title: '${json['title'] ?? ''}',
