  ...
  AppRouter(this._authSession) {
    ...
    router = GoRouter(
      ...
      routes: [
        GoRoute(
          path: '/login',
          builder: (_, __) => LoginPage(authSession: _authSession),
        ),
        GoRoute(
          path: '/',
          builder: (_, __) => DashboardPage(authSession: _authSession),
        ),
        GoRoute(
          path: '/projects',
        ...
        GoRoute(
          ...
          builder: (_, state) =>
              TasksPage(projectId: state.pathParameters['id']!),
        ),
        GoRoute(
          path: '/finance',
        ...
        GoRoute(
          ...
          builder: (_, state) =>
              FinancePage(projectId: state.pathParameters['id']!),
        ),
        GoRoute(
          path: '/crm',
        ...
        GoRoute(
          ...
          builder: (_, state) =>
              DocumentsPage(projectId: state.pathParameters['id']!),
        ),
        GoRoute(
          path: '/account',
          builder: (_, __) => AccountPage(authSession: _authSession),
        ),
      ],
    );
  }
